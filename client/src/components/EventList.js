...
const dummyEvents = [
    {
        background: '/images/dummy-event1.jpg', // Ensure this image is in public/images
    ...
    {
        background: '/images/dummy-event2.jpg',
    ...
    {
        background: '/images/dummy-event3.jpg',
    ...
    {
        background: '/images/dummy-event4.jpg',
    ...
    {
        background: '/images/dummy-event5.jpg',
    ...
    {
        background: '/images/dummy-event6.jpg',
